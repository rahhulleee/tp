 ...
 * Guarantees: immutable; policyName is valid as declared in {@link #isValidPolicyNameOrNumber(String)}
 */
public class Policy {
     ...
     */
    public static boolean isValidPolicyNameOrNumber(String field) {
